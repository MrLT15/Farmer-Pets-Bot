...
const NKFE_PAYOUT_WEBHOOK_URL = env("NKFE_PAYOUT_WEBHOOK_URL", "");
const NKFE_PAYOUT_WEBHOOK_SECRET = env("NKFE_PAYOUT_WEBHOOK_SECRET", "");
const NKFE_PAYOUT_MEMO = env("NKFE_PAYOUT_MEMO", "Farmer Pets weekly $NKFE payout");
...
module.exports = {
  ...
  NKFE_TOKEN_CONTRACT,
  NKFE_TOKEN_SYMBOL,
  NKFE_PAYOUT_WEBHOOK_URL,
  NKFE_PAYOUT_WEBHOOK_SECRET,
  NKFE_PAYOUT_MEMO,
