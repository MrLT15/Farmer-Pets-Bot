...
const FARMER_PETS_INSTANCE_LOCK_ENABLED = envFlag("FARMER_PETS_INSTANCE_LOCK_ENABLED", false);
...
const WAX_RPC_URL = env("WAX_RPC_URL", "https://wax.greymass.com");
const NKFE_PAYOUT_SOURCE_WALLET = env("NKFE_PAYOUT_SOURCE_WALLET", "roadisledger");
const NKFE_TREASURY_PRIVATE_KEY = env("NKFE_TREASURY_PRIVATE_KEY", "");
const NKFE_TOKEN_CONTRACT = env("NKFE_TOKEN_CONTRACT", "");
const NKFE_TOKEN_SYMBOL = env("NKFE_TOKEN_SYMBOL", "NKFE");
const NKFE_TOKEN_PRECISION = envInteger("NKFE_TOKEN_PRECISION", 4);
...
const NKFE_PAYOUT_DECIMAL_FALLBACKS = env("NKFE_PAYOUT_DECIMAL_FALLBACKS", "4");
...
const FARM_EVENT_DURATION_MINUTES = envInteger("FARM_EVENT_DURATION_MINUTES", 5);
const COMMUNITY_EVENT_DURATION_MINUTES = envInteger("COMMUNITY_EVENT_DURATION_MINUTES", 10);
...
module.exports = {
  ...
  COMMUNITY_EVENT_DURATION_MS: COMMUNITY_EVENT_DURATION_MINUTES * 60 * 1000,
